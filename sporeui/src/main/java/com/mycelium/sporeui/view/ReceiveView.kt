...
import com.mycelium.sporeui.ui.SendRecyclerViewAdapter2
import com.mycelium.sporeui.ui.SenderRecyclerViewItem2
...
class ReceiveView constructor(context: Context = null!!, attrs: AttributeSet = null!!)
    : LinearLayout(context, attrs) {

    @Inject
    lateinit var receiveScreenPresenter: ReceiveScreenPresenter
    ...
    private val marker = ReceiveView::class.qualifiedName
    ...
    override fun onAttachedToWindow() {
        ...
        receiveScreenPresenter.takeView(this)
    }

    override fun onDetachedFromWindow() {
        receiveScreenPresenter.dropView(this)
    ...
    val senderAccounts : MutableList<SenderRecyclerViewItem2> = ArrayList()
    ...
    override fun onFinishInflate() {
        ...
        val screen: ReceiveScreen = Flow.getKey<ReceiveScreen?>(this)!!
/*
...
*/
        ...
        sendCurrencySymbol.setOnClickListener(
                object : View.OnClickListener {
                    override fun onClick(v: View?) {
                        receiveScreenPresenter.changeCurrency(
                                ReceiveScreenPresenter.CURRENCY.valueOf(sendCurrencySymbol.text.toString()),
        ...
        senderVTO.addOnPreDrawListener(object : ViewTreeObserver.OnPreDrawListener{
            override fun onPreDraw(): Boolean {
                ...
                val myItems : List<SenderRecyclerViewItem2> = receiveScreenPresenter.getSenderAccountsList()
                senderAccounts.addAll(myItems)
                val senderAccountsRecyclerViewAdapter : SendRecyclerViewAdapter2 =
                        SendRecyclerViewAdapter2(senderAccounts.toTypedArray(),
                                senderFirstItemWidth.toInt(),
                                object : SendRecyclerViewAdapter2.ViewHolder.ViewHolderClickListener {
                                    override fun onClick(adapter : SendRecyclerViewAdapter2, position: Int) {
        ...
        receiverVTO.addOnPreDrawListener(object : ViewTreeObserver.OnPreDrawListener{
            override fun onPreDraw(): Boolean {
                ...
                val myItems : List<ReceiverRecyclerViewItem> = receiveScreenPresenter.getReceiverAccountsList()
    ...
    private fun calculatePositionAndScroll(recyclerView: RecyclerView) {
        if(recyclerView.adapter is SendRecyclerViewAdapter2) {
    ...
    private fun setSelectedItem(adapter: RecyclerView.Adapter<RecyclerView.ViewHolder>) {
        if(adapter is SendRecyclerViewAdapter2) {
