 ...
 */
public class SenderRecyclerViewItem
    extends AbstractFlexibleItem<SenderRecyclerViewItem.ViewHolder> {
  private String category;
  private String item;
  private String value;
  private int type;

  public SenderRecyclerViewItem(String category, String item, String value, int type) {
  ...
  public boolean equals(Object o) {
    ...
    SenderRecyclerViewItem that = (SenderRecyclerViewItem) o;
  ...
  public int getLayoutRes() {
    if(type == SendRecyclerViewAdapter.VIEW_TYPE_ITEM) {
      return R.layout.sender_recyclerview_item;
    } else {
      return R.layout.list_item_padding_sender;
    }
  }
