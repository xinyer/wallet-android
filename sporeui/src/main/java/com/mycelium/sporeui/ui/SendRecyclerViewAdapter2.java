...
public class SendRecyclerViewAdapter2
    extends RecyclerView.Adapter <SendRecyclerViewAdapter2.ViewHolder> {

  private SenderRecyclerViewItem2[] mDataset;
  ...
  public SendRecyclerViewAdapter2(SenderRecyclerViewItem2[] dataset, int paddingWidth,
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent,
    ...
    if (viewType == VIEW_TYPE_ITEM) {
      ...
      View v = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.sender_recyclerview_item2, parent, false);
      // set the view's size, margins, paddings and layout parameters
      //...
      return new ViewHolder(v, this, viewHolderClickListener);
    } else {
      View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_padding_sender2,
          parent, false);
  ...
  public void setSelecteditem(int selecteditem) {
    ...
    //viewHolderClickListener.onClick(this, selecteditem, false);
  }
  ...
  public int getItemViewType(int position) {
    SenderRecyclerViewItem2 item = mDataset[position];
    return item.getType();
  }
  ...
  implements View.OnClickListener, View.OnLongClickListener {
    ...
    SendRecyclerViewAdapter2 adapter;

    public ViewHolder(View v, SendRecyclerViewAdapter2 adapter,
                      ViewHolderClickListener viewHolderClickListener) {
      super(v);
    ...
    public static interface ViewHolderClickListener {
      public void onClick(SendRecyclerViewAdapter2 adapter, int position);
    }
  }
}
