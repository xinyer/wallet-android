 ...
 */
public class SenderRecyclerViewItem2
    extends AbstractFlexibleItem<SenderRecyclerViewItem2.ViewHolder> {
  private String category;
  private String item;
  private String value;
  private int type;

  public SenderRecyclerViewItem2(String category, String item, String value, int type) {
  ...
  public boolean equals(Object o) {
    ...
    SenderRecyclerViewItem2 that = (SenderRecyclerViewItem2) o;
  ...
  public int getLayoutRes() {
    if(type == SendRecyclerViewAdapter.VIEW_TYPE_ITEM) {
      return R.layout.sender_recyclerview_item2;
    } else {
      return R.layout.list_item_padding_sender2;
    }
  }
