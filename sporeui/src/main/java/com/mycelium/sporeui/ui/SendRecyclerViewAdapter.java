...
public class SendRecyclerViewAdapter
    extends RecyclerView.Adapter <SendRecyclerViewAdapter.ViewHolder> {

  private SenderRecyclerViewItem[] mDataset;
  ...
  public SendRecyclerViewAdapter(SenderRecyclerViewItem[] dataset, int paddingWidth,
  ...
  public ViewHolder onCreateViewHolder(ViewGroup parent,
    ...
    if (viewType == VIEW_TYPE_ITEM) {
      ...
      View v = LayoutInflater.from(parent.getContext())
          .inflate(R.layout.sender_recyclerview_item, parent, false);
  ...
  public int getItemViewType(int position) {
    SenderRecyclerViewItem item = mDataset[position];
    return item.getType();
  }
  ...
  implements View.OnClickListener, View.OnLongClickListener {
    ...
    SendRecyclerViewAdapter adapter;

    public ViewHolder(View v, SendRecyclerViewAdapter adapter,
                      ViewHolderClickListener viewHolderClickListener) {
      super(v);
    ...
    public static interface ViewHolderClickListener {
      public void onClick(SendRecyclerViewAdapter adapter, int position);
    }
  }
}
