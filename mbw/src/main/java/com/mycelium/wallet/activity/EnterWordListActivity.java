   ...
   private class MasterSeedFromWordsAsyncTask extends AsyncTask<Void, Integer, UUID> {
      ...
      protected UUID doInBackground(Void... params) {
         try {
            ...
            _mbwManager.getWalletManager().configureBip32MasterSeed(masterSeed, AesKeyCipher.defaultKeyCipher());
            _mbwManager.getMetadataStorage().setMasterSeedBackupState(MetadataStorage.BackupState.VERIFIED);
            return _mbwManager.getWalletManager().createAdditionalBip44Account(AesKeyCipher.defaultKeyCipher());
